          ...
          <div className="mt-4">
            {pieChartData.map((entry, index) => (
              <div key={index} className="flex items-center space-x-2">
                ...
                <p className="text-sm">{entry.name}: {entry.value} participants</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg mt-6">
        ...
        <div className="flex justify-center mt-4 space-x-2">
          ...
          {Array.from({ length: totalPages }, (_, i) => (
            <button
              key={i}
              className={`px-4 py-2 rounded-md ${page === i + 1 ? "bg-blue-700 text-white" : "bg-gray-100"}`}
              onClick={() => setPage(i + 1)}
            >
              {i + 1}
            </button>
          ...
          <button
            className={`px-4 py-2 rounded-md ${page === totalPages ? "bg-gray-200" : "bg-blue-700 text-white"}`}
