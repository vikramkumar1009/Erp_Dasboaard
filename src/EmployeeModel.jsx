...
const EmployeeModel = ({ modalType, onClose, employees, setEmployees }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-200 bg-opacity-70 backdrop-blur-md">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 md:w-96 max-w-md relative z-10">
        {/* Close Button */}
        ...
        {(modalType === "delete" || modalType === "edit") && !foundEmployee ? (
          ...
          <>
            <p className="text-center text-gray-700">
              Are you sure you want to delete employee <b>{foundEmployee?.name}</b>?
            </p>
          ...
          {(modalType !== "delete" || foundEmployee) && (
            <button
              ...
              className={`px-6 py-2 rounded text-white w-full ${
                modalType === "delete" ? "bg-red-500 hover:bg-red-600" : "bg-blue-900 hover:bg-blue-700"
              }`}
            >
